...
4. Try to delete any of the inner blocks with a padlock next to it. This should not be possible.
5. Go to the Checkout page in the editor.
6. Try to unlock every inner block with a padlock icon next to it (except Order Note block, this is locked for moving, but not for removing). This should not be possible.
7. Try to delete any of the inner blocks with a padlock next to it. This should not be possible.
...
1. Try to delete any of the inner blocks with a padlock next to it. This should not be possible.
2. Go to the Checkout page in the editor.
3. Try to unlock every inner block with a padlock icon next to it (except Order Note block, this is locked for moving, but not for removing). This should not be possible.
4. Try to delete any of the inner blocks with a padlock next to it. This should not be possible.
